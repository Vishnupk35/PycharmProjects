...
urlpatterns = [
    ...
    path("operations/sub/",views.SubNumbersView.as_view()),
    path("operations/cube/",views.CubeView.as_view()),
    path("operations/fact/",views.FactorialView.as_view()),
    ...
    path("social/posts/likes/<int:post_id>/",pview.AddLikeView.as_view()),
